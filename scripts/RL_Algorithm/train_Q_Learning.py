...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlOnPolicyRunnerCfg):
    ...
    # File name for tensor board log & Q_values
    # Change only this `save_name` and create new folder in q_value/Stabilize with the same name!!!
    save_name = 'Q_learning_rerun_df_09'
    # Epsilon _decay 0.9995 in progress na, if this training done
    # Tenggy should be run with discount factor or another algorithm na >.< CU tmr
    ##########################################
        ...
        with torch.inference_mode():
            ...
            for episode in tqdm(range(n_episodes)):
                ...
                while not done:
                    ...
                    agent.update(
                        obs_dis, action_idx, reward, next_obs_dis
                    )
