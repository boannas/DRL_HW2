...
def main():
    ...
    # discretize_state_weight = [1, 1, 1, 1]  # [pose_cart:int, pose_pole:int, vel_cart:int, vel_pole:int]
    # learning_rate = 0.1
    # n_episodes = 5
    # start_epsilon = 1
    ...
    discretize_state_weight = [5, 10, 5, 5]   # [pose_cart:int, pose_pole:int, vel_cart:int, vel_pole:int]
    learning_rate = 0.1
    # n_episodes = 10
    start_epsilon = 0.5
    epsilon_decay = 0.995  # reduce the exploration over time
