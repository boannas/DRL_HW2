...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlOnPolicyRunnerCfg):
    ...
    save_name = '2Q_Learning_rerun_df_09'
    ...
    while simulation_app.is_running():
        ...
        with torch.inference_mode():
            ...
            for episode in tqdm(range(n_episodes)):
                ...
                writer.add_histogram("Q-Values/QA Distribution", np.array(list(agent.qa_values.values())), episode)
                writer.add_histogram("Q-Values/QB Distribution", np.array(list(agent.qb_values.values())), episode)
